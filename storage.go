...
func initializeBucket(w http.ResponseWriter, buCh chan *storage.BucketHandle) {
	opt := option.WithCredentialsFile(JSON_FILE)
...
func UploadImage(w http.ResponseWriter, r *http.Request) {
	...
	Data := CreateResponseStoreImage(imageId, path)
...
func DeleteImage(w http.ResponseWriter, r *http.Request) {
	...
	Data := CreateResponseDeleteImage("Image deleted")
...
func CreateResponseStoreImage(imageId string, path string) interface{} {
...
func CreateResponseDeleteImage(msg string) interface{} {
	Data := struct {
		Msg string
	}{
		Msg: "Image deleted",
